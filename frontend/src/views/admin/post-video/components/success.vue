<template>
  <div class="success-wrap">
    ...
    />
    <a-space :size="16">
      <a-button key="view" type="primary" @click="emits('jumpToVideo')">
    ...
    <div class="details-wrapper">
      ...
      <a-typography-paragraph style="margin-bottom: 0">
        ...
        <a-link href="link" disabled>{{ $t('stepForm.button.view') }}</a-link>
...
const emits = defineEmits(['changeStep', 'jumpToVideo'])
const oneMore = () => {
  emits('changeStep', 1)
}
</script>
