export default {
  ...
  'userSetting.tab.basicInformation': '编辑基础信息',
  'userSetting.tab.securitySettings': '安全设置',
  'userSetting.tab.certification': '实名认证',
  'userSetting.basicInfo.form.label.email': '邮箱',
  'userSetting.basicInfo.placeholder.email': `请输入邮箱地址，如xxx{'@'}dianying.com`,
  'userSetting.form.error.email.required': '请输入邮箱',
  'userSetting.basicInfo.form.label.password': '密码',
  'userSetting.basicInfo.placeholder.password': `请输入登录密码，不少于6位`,
  'userSetting.form.error.password.required': '请输入登录密码',
  'userSetting.form.error.password.minLength': '密码应不少于6位',
  ...
  'userSetting.basicInfo.placeholder.age': '请输入您的年龄',
  'userSetting.form.error.age.required': '请输入年龄',
  'userSetting.form.error.age.number': '请输入数字',
  ...
  'userSetting.basicInfo.form.label.signature': '个人简介',
  'userSetting.basicInfo.placeholder.signature': '请输入您的个人简介，最多不超过100字。',
  'userSetting.form.error.signature.maxLength': '最多不超过100字',
