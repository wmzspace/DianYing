export default {
  ...
  'userSetting.tab.basicInformation': 'Edit Basic Information',
  ...
  'userSetting.basicInfo.placeholder.email': `Please enter your email address, such as xxx{'@'}dianying.com`,
  'userSetting.form.error.email.required': 'Please enter email address',
  'userSetting.basicInfo.form.label.password': 'password',
  'userSetting.basicInfo.placeholder.password': `Please enter your password, no less than 6 digits`,
  'userSetting.form.error.password.required': 'Please enter your password',
  'userSetting.form.error.password.minLength': 'Password should no less than 6 digits',
  ...
  'userSetting.basicInfo.placeholder.gender': 'Please choose your gender',
  'userSetting.form.error.gender.required': 'Please choose your gender',
  'userSetting.basicInfo.form.label.age': 'Age',
  'userSetting.basicInfo.placeholder.age': 'Please enter your age',
  'userSetting.form.error.age.required': 'Please enter your age',
  'userSetting.form.error.age.number': 'Please enter a number',
  ...
  'userSetting.basicInfo.form.label.signature': 'Personal signature',
  'userSetting.basicInfo.placeholder.signature':
    'Please enter your signature, no more than 100 words',
  'userSetting.form.error.signature.maxLength': 'No more than 100 words',
